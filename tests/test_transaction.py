...
class TestTransaction:
    ...
    def test_commit_already_committed(self):
        ...
        with pytest.raises(ValueError, match="Cannot commit transaction in state TransactionState.COMMITTED"):
            self.transaction.commit()
    ...
    def test_commit_already_rolled_back(self):
        ...
        with pytest.raises(ValueError, match="Cannot commit transaction in state TransactionState.ROLLED_BACK"):
            self.transaction.commit()
    ...
    def test_rollback_already_committed(self):
        ...
        with pytest.raises(ValueError, match="Cannot rollback transaction in state TransactionState.COMMITTED"):
            self.transaction.rollback()
    ...
    def test_rollback_already_rolled_back(self):
        ...
        with pytest.raises(ValueError, match="Cannot rollback transaction in state TransactionState.ROLLED_BACK"):
            self.transaction.rollback()
...
class TestTransactionManager:
    ...
    def test_cleanup_abandoned_transactions_custom_timeout(self):
        ...
        transaction_id2 = self.manager.begin_transaction(self.session_id, self.mock_connection)
...
class TestTransactionIntegration:
    ...
    def test_abandoned_transaction_cleanup_integration(self):
        ...
        abandoned_txn1 = manager.begin_transaction("abandoned_session1", abandoned_connection1)
        abandoned_txn2 = manager.begin_transaction("abandoned_session2", abandoned_connection2)
