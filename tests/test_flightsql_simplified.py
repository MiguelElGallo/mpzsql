...
class TestActionDispatching:
    ...
    def test_handle_action_create_prepared_statement(self):
        ...
        with patch.object(self.simplified, '_handle_create_prepared_statement') as mock_handler:
            ...
            result = self.simplified.handle_action("CreatePreparedStatement", b"test_data")
    ...
    def test_handle_action_close_prepared_statement(self):
        ...
        with patch.object(self.simplified, '_handle_close_prepared_statement') as mock_handler:
            ...
            result = self.simplified.handle_action("ClosePreparedStatement", b"test_data")
    ...
    def test_handle_action_statement_query(self):
        ...
        with patch.object(self.simplified, '_handle_statement_query') as mock_handler:
            ...
            result = self.simplified.handle_action("CommandStatementQuery", b"test_data")
...
class TestSQLExtraction:
    ...
    def test_extract_sql_from_bytes_protobuf_parsing(self):
        ...
        with patch('mpzsql.flightsql.protobuf.FlightSQLProtobuf') as mock_protobuf:
            ...
            mock_protobuf.parse_command_statement_query.assert_called_once_with(b"protobuf_data")
    ...
    def test_extract_sql_from_bytes_protobuf_prepared_statement(self):
        ...
        with patch('mpzsql.flightsql.protobuf.FlightSQLProtobuf') as mock_protobuf:
            ...
            mock_protobuf.parse_create_prepared_statement_request.return_value = "SELECT COUNT(*) FROM table"
            
            result = self.simplified._extract_sql_from_bytes(b"protobuf_data")
            
            assert result == "SELECT COUNT(*) FROM table"
            mock_protobuf.parse_create_prepared_statement_request.assert_called_once_with(b"protobuf_data")
...
class TestPreparedStatements:
    ...
    def test_handle_close_prepared_statement_cleanup(self):
        ...
        for i in range(150):
            self.simplified.prepared_statements[f"stmt_{i}"] = {'sql': f'SELECT {i}', 'schema': None}
...
class TestIntegrationScenarios:
    ...
    def test_full_prepared_statement_workflow(self):
        ...
        with patch.object(self.simplified, '_extract_sql_from_bytes') as mock_extract:
            ...
            with patch('mpzsql.flightsql.protobuf.FlightSQLProtobuf') as mock_protobuf:
                ...
                result = self.simplified.handle_action("CreatePreparedStatement", b"request_data")
    ...
    def test_metadata_workflow(self):
        ...
        assert all(isinstance(r, pf.Result) for r in [
            catalogs_result, schemas_result, tables_result, types_result
        ])
