...
class TestServerActions:
    ...
    def test_create_prepared_statement_action(self, mock_protobuf, mock_request_class, server):
...
class TestFlightInfoGeneration:
    ...
    def test_get_flight_info_statement(self, server):
        ...
        assert isinstance(flight_info, pf.FlightInfo)
        server.backend.get_statement_schema.assert_called_once_with("SELECT * FROM test_table")
    ...
    def test_get_flight_info_catalogs(self, server):
        ...
        with patch('src.mpzsql.flightsql.protobuf.FlightSQLProtobuf.get_catalogs_schema') as mock_schema:
...
class TestCommandParsing:
    ...
    @patch('src.mpzsql.flightsql.protobuf.FlightSQLProtobuf.parse_command_statement_query')
...
class TestPreparedStatementFlightInfo:
    ...
    def test_get_flight_info_prepared_statement(self, server):
        ...
        test_schema = pa.schema([pa.field("col1", pa.int64()), pa.field("col2", pa.string())])
    ...
    def test_get_flight_info_prepared_statement_fallback_schema(self, server):
        ...
        server.backend.get_statement_schema.assert_called_once_with("SELECT * FROM test_table WHERE id = ?")