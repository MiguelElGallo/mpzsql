...
def test_import_backends():
    ...
    from mpzsql.backends import base
    from mpzsql.backends import duckdb_backend
    from mpzsql.backends import sqlite_backend
...
def test_import_flightsql():
    ...
    from mpzsql.flightsql import server_base
    from mpzsql.flightsql import protocol
