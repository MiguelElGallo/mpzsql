...
class TestDuckDBBackendBasedOnLogs:
    ...
    def test_connection_initialization_with_init_sql(self):
...
class TestDuckDBBackendErrorScenarios:
    ...
    def test_corrupted_init_sql(self):
    ...
    def test_get_tables_with_invalid_catalog(self):
    ...
    def test_get_db_schemas_with_invalid_catalog(self):
